...
Originally adapted from duck study `r citep('10.1128/JVI.78.9.4892-4901.2004')` ~ but unclear how exactly. Existing models deal with village- or flock-level transmission, not individuals. For example, in West Bengal`r citep('10.1038/srep02175')`: $1.00 * 10^{-8}$, originally taken from a study in wild birds `r citep('10.3934/dcdsb.2012.17.2829')`. 

In an experimental study of close-quarter chicken-to-chicken transmission of __H5N1 HPAI__, $\beta_{PP}$ was estimated between 0.74 to 0.8, depending on the inoculated dose `r citep('10.1371/journal.ppat.1000281')`. 
...
Transmission of __H5N3 LPAI__ from ducks to chickens measured via experimental, close quarters interaction resulted in an indivdidual duck $\beta_{WP}$ of 0.3 infections/day. The authors of this study also investigated transmission via drinking water contaminated with duck feces (using a small, realistic amount of fecal contamination), showing that it lead to seroconversion in 50% of chickens exposed to it and vRNA in all chickens. Seroconversion via fomites on surfaces was not observed, although some vRNA was detected in oropharynges and cloacae `r citep('10.1017/S0950268813002793')`.
